...
description: Erfahren Sie, wie Sie ein Bildset erstellen.
...
1. Führen Sie einen der folgenden Schritte aus:
   ...
   * **Wählen Sie zuerst**  die Bilder aus: Wählen Sie im Durchsuchenbedienfeld die Bilder aus, die Sie für das Bildset verwenden möchten, und klicken Sie auf  **[!UICONTROL Erstellen]**  >  **[!UICONTROL Bildsets]**.

   * **Starten Sie im Bildschirm**  Bildset - Klicken Sie auf  **[!UICONTROL Erstellen]**  >  **[!UICONTROL Bildsets]**. Der Anzeigebereich „Bildsatz“ wird geöffnet. Wählen Sie in der Asset-Bibliothek einen Ordner aus und ziehen Sie die Bilder, die Sie für den Bildsatz verwenden möchten, in den Anzeigebereich „Bildsatz“.
...
1. Klicken Sie auf **[!UICONTROL Speichern]**, wählen Sie einen Ordner zum Speichern des Bildsatzes aus, geben Sie einen Namen für den Bildsatz ein und klicken Sie auf **[!UICONTROL Speichern]**.
1. Wenn Sie den Bildsatz im Bildsatz-Viewer anzeigen möchten, klicken Sie im Anzeigebereich „Bildsatz“ auf die Schaltfläche **[!UICONTROL Vorschau]**. Durch Klicken auf Muster-Miniaturansichten im Bildsatz-Viewer können Sie anzeigen, wie sich diese verhalten.
...
1. Wählen Sie in der Rasteransicht den gewünschten Bildsatz und klicken Sie unterhalb des Bildes auf **[!UICONTROL Bearbeiten]**.
1. Führen Sie einen der folgenden Schritte aus:
   ...
   * Um ein Bild zu entfernen, wählen Sie es aus und klicken Sie in der Symbolleiste auf **[!UICONTROL Löschen]**.
...
1. Klicken Sie auf **[!UICONTROL Speichern]**, wählen Sie einen Speicherordner für das Set aus, geben Sie einen Namen für das Set ein und klicken Sie auf **[!UICONTROL Speichern]**.
