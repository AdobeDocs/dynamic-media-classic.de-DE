...
Verwenden Sie den Anzeigebereich &quot;Adobe Analytics-Konfiguration&quot;, um Viewer-Ereignis Adobe Analytics-Variablen und Dynamic Media Classic-Variablen zuzuordnen. Wählen Sie für jedes Viewer-Ereignis eine Adobe Analytics-Variable und eine Dynamic Media Classic-Variable. Anweisungen zum Öffnen des Anzeigebereichs „Adobe Analytics-Konfiguration“ finden Sie unter [Anmelden bei Adobe Analytics](log-analytics.md#log_in_to_adobe_analytics).
...
1. Klicken Sie auf **Speichern**.
   ...
   Nachdem Sie auf &quot;Speichern&quot;geklickt haben, werden das Viewer-Ereignis, die zugehörige Adobe Analytics-Variable und die zugehörige Dynamic Media Classic-Variable im Anzeigebereich &quot;Adobe Analytics-Konfiguration&quot;aufgelistet.
...
For each viewer event on Adobe Analytics Configuration screen, choose a Adobe Analytics variable and a *Dynamic Media Classic variable*. Dynamic Media Classic-Variablen stellen Daten dar, die Sie für einen Bericht abrufen können. Zum Beispiel listet die Variable `searchTerm` Schlüsselwörter auf, die in E-Katalog-Suchvorgängen verwendet wurden.

In der folgenden Tabelle werden die Dynamic Media Classic-Variablen beschrieben.
...
* **Bearbeiten** Wählen Sie ein Viewer-Ereignis aus und klicken Sie auf die graue Schaltfläche &quot; **[!UICONTROL Ansicht/Variablen bearbeiten]** &quot;. Wählen Sie in den Dropdown-Listen &quot;Dynamic Media Classic Variable&quot;und &quot;Adobe Analytics Variable&quot;aus den jeweiligen Listen eine andere Variable aus. Weitere Informationen finden Sie unter Zuweisen von Adobe Analytics-Variablen zu Dynamic Media Classic Viewer-Ereignissen und -Variablen.
