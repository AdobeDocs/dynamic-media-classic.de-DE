...
description: Erfahren Sie mehr über die Bildbearbeitungsoptionen, die zum Zeitpunkt des Uploads verfügbar sind.
...
Diese Optionen befinden sich auf der Seite &quot;Hochladen&quot;unter &quot;Bildbearbeitungsoptionen&quot;.

## Beschneiden von Bildern zum Entfernen weißer Flächen

Um automatisch Leerraum-Pixel aus einem Bild zu beschneiden, klicken Sie im Dialogfeld &quot;Upload-Auftragsoptionen&quot;auf **[!UICONTROL Zuschnittsoptionen]**. Wählen Sie in der Dropdownliste **[!UICONTROL Zuschneiden]** **[!UICONTROL Zuschneiden]** aus. Anschließend können Sie folgende Optionen wählen:

* **Entfernen basierend auf**  - Wählen Sie aus dieser Dropdownliste aus, ob Sie basierend auf Farbe oder Transparenz zuschneiden möchten:

   * **Farbe**  - Wählen Sie die  **** Farboption aus. Wählen Sie dann aus der Dropdownliste **[!UICONTROL Ecke]** die Ecke des Bildes mit der Farbe aus, die am besten der zu beschneidenden Leerraum-Farbe entspricht.

   * **Transparenz**  - Wählen Sie die Option &quot;Transparenz&quot;.

* **Toleranz**  - Ziehen Sie den Regler, um eine Toleranz von 0 bis 1 festzulegen:
...
Um eine Maske für das Bild basierend auf den Beschneidungspfadinformationen zu erstellen, klicken Sie auf **[!UICONTROL Maske aus Beschneidungspfad erstellen]**. Diese Option betrifft Bilder, die unter Verwendung eines Beschneidungspfads erstellt wurden.
...
Siehe auch [Scharfzeichnen von Bildern in Scene7 Publishing System und Image-Server](/help/assets/s7_sharpening_images.pdf).
