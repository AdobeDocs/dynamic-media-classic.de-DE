...
**Unscharf maskieren** Ermöglicht die Feinabstimmung eines Scharfzeichnungsfiltereffekts auf das endgültige neu berechnete Bild. Sie können die Intensität des Effekts, den Radius des Effekts (gemessen in Pixel) und einen Schwellenwert für den Kontrast steuern, der ignoriert wird. Dieser Effekt verwendet dieselben Optionen wie der Photoshop-Filter „Unscharf maskieren“. (URL: op_usm)
