...
description: Erfahren Sie, wie Sie einen E-Katalog erstellen.
...
1. Wählen Sie zu Beginn der Erstellung eines E-Katalogs eine der folgenden Vorgehensweisen:
   ...
   * **Beginn im Anzeigebereich**  &quot;E-Katalog&quot;- Klicken Sie auf  **[!UICONTROL &quot;Erstellen]** &quot;> &quot; **[!UICONTROL E-Kataloge]**&quot;. Wählen Sie in der Asset-Bibliothek einen Ordner aus und ziehen Sie die gewünschten Dateien dann aus dem Ordner auf die Registerkarte „Seiten ordnen“ der Seite „E-Katalog“.
...
1. Wählen Sie ein Gesamtlayout für den E-Katalog aus. Klicken Sie für Einzelseiten auf „1-fach“ , für doppelseitige Druckbögen auf „2-fach“  oder für Druckbögen mit mehr als zwei Seiten auf „Benutzerdefiniert“ . Das Dialogfeld „E-Katalog-Layout ändern“ wird angezeigt. Wählen Sie die Optionen &quot;Alle Druckbögen&quot;aus und klicken Sie auf **[!UICONTROL OK]**.
1. Sie können optional das Layout einzelner Seiten oder Druckbögen ändern, indem Sie darauf klicken und dann **[!UICONTROL 1 Up]**, **[!UICONTROL 2 Up]** oder **[!UICONTROL Benutzerdefiniert]**-Schaltfläche auswählen. Das Dialogfeld „E-Katalog-Layout ändern“ wird angezeigt. Wählen Sie die Optionen für die ausgewählten Druckbögen aus und klicken Sie auf **[!UICONTROL OK]**.
1. Ordnen Sie die Seiten mit einem der folgenden Verfahren nach Bedarf neu an:

   * **Ziehen** : Ziehen Sie eine Seite oder einen Druckbogen an eine neue Position. Die vertikale Leiste zeigt an, wohin die Seite verschoben wird.

   * **Schaltfläche**  &quot;Verschieben nach&quot;: Wählen Sie eine Seite oder einen Druckbogen aus, klicken Sie auf &quot; **[!UICONTROL Verschieben nach]**&quot;und wählen Sie im Menü die Seite aus, vor der die Seite angezeigt werden soll.
...
Je nachdem, ob Sie ein veröffentlichtes oder unveröffentlichtes Set bearbeiten, wirkt sich die Option **[!UICONTROL Nach dem Speichern veröffentlichen]** wie folgt auf das Set und die Set-Mitglieder aus:
...
Die Inhaltsverzeichnis-Beschriftung wird im Feld &quot;Benutzerdaten&quot;eines Bilds gespeichert. diese Daten als Liste von `name=<value>` ` pairs separated by two question marks “??” ` formatieren. Um beispielsweise eine Beschriftung für ein Inhaltsverzeichnisfeld mit dem Namen `tocEN` festzulegen, setzen Sie im Feld „Benutzerdaten“ des Bilds folgenden Wert:
...
Um das Feld &quot;Benutzerdaten&quot;in eine tabulatorgetrennte Datei zu importieren, geben Sie die Feldbenutzerdaten ein:
