...
Integrieren von Dynamic Media Classic mit Adobe Analytics OAuth. Die Adobe Analytics OAuth-Integration mit Dynamic Media Classic wird in der Regel nur einmal pro Benutzerin bzw. Benutzer durchgeführt.
...
1. Wählen Sie eine der folgenden Optionen aus:
   ...
   * Wählen Sie oben auf der Seite die Registerkarte **[!UICONTROL Projekte]** aus. Klicken Sie in der rechten Ecke der Seite auf **[!UICONTROL Neues Projekt erstellen]**.
...
1. Gehen **[!UICONTROL unter &quot;]**&quot; wie folgt vor:
   * Wählen **[!UICONTROL unter]** Client-ID) die Option **[!UICONTROL Kopieren]** aus, um den Wert zu kopieren. Sie benötigen diesen Wert für die nachfolgende Analytics-Konfiguration im Dynamic Media Classic-Desktop-Programm.
   * Wählen **[!UICONTROL unter &quot;]**&quot; die Option **[!UICONTROL Client-Geheimnis abrufen]** aus, um den zugehörigen Wert anzuzeigen. Wählen Sie **[!UICONTROL Kopieren]** aus, um den Wert zu kopieren. Sie benötigen diesen Wert für die nachfolgende Adobe Analytics-Konfiguration im Dynamic Media Classic-Desktop-Programm.

## Konfigurieren von Adobe Analytics in Adobe Dynamic Media Classic {#configure-analytics-in-dmc}

>[!NOTE]
>
>Nach der Erstkonfiguration von Adobe Analytics in Dynamic Media Classic müssen Sie die Konfiguration nur noch im folgenden Fall wiederholen:
>
...
1. Wählen Sie unten rechts im Dialogfeld die Option **[!UICONTROL Anmelden]** aus und melden Sie sich bei Adobe IMS (Identity Management Services) an.
   ...
   Bei erfolgreicher Anmeldung wird erneut das Adobe Analytics-Anmeldedialogfeld zusammen mit der Dropdown-Liste **[!UICONTROL UNTERNEHMEN]** angezeigt, in der die für Sie verfügbaren Unternehmen aufgeführt sind.

1. Wählen Sie aus **[!UICONTROL Dropdown]** Liste „UNTERNEHMEN“ ein Unternehmen aus.

   Nachdem Sie ein Unternehmen ausgewählt haben **[!UICONTROL wird die Dropdown]** Liste „SUITES“ angezeigt, in der die für das ausgewählte Unternehmen verfügbaren Report Suites aufgeführt sind.
