...
Um in Adobe Analytics festzulegen, welche Informationen in Adobe Analytics-Berichten enthalten sein sollen, rufen Sie den Anzeigebereich „Adobe Analytics-Konfiguration“ auf. Nach der Konfiguration werden auf diesem Bildschirm eine entsprechende Adobe Analytics-Variable und eine Adobe Dynamic Media Classic-Variable für jedes Viewer-Ereignis aufgelistet, zu dem Sie Informationen wünschen. Diese Viewer-Ereignisse, Adobe Analytics-Variablen und Adobe Dynamic Media Classic-Variablenkombinationen bestimmen, welche Informationen gemeldet werden.
...
1. Nachdem Sie sich von Dynamic Media Classic aus bei Adobe Analytics angemeldet und eine Report Suite ausgewählt haben, aktivieren Sie ein Viewer-Ereignis auf der Adobe Analytics-Konfigurationsseite, indem **[!UICONTROL Aktivieren]** in der rechten Tabellenspalte auswählen.
1. Zeigen Sie in der Spalte Variablen die Auswahl der Variablenpaare an, indem Sie die Pfeilschaltfläche für das gewünschte Viewer-Ereignis auswählen.
...
1. Wählen Sie **[!UICONTROL Speichern]** aus.
   ...
   Nachdem Sie auf **[!UICONTROL Speichern]** geklickt haben, werden das Viewer-Ereignis, die zugehörige Adobe Analytics-Variable und die zugehörige Adobe Dynamic Media Classic-Variable im Adobe Analytics-Konfigurationsbildschirm aufgeführt.
...
Viewer-Ereignisse beschreiben Aktionen, die Benutzende mit Dynamic Media Classic-Viewern ausführen. Wenn ein Benutzer eine Aktion initiiert, z. B. eine Miniaturansicht auszuwählen oder ein Video zu starten oder zu stoppen, sendet der Viewer ein Ereignis an die Web-Seite. Mit diesem Ereignis verknüpfte Daten werden ebenfalls gesendet.
...
Wählen Sie für jedes Viewer-Ereignis auf dem Adobe Analytics-Konfigurationsbildschirm eine Adobe Analytics-Variable und eine *Adobe Dynamic Media Classic-Variable*. Adobe Dynamic Media Classic-Variablen geben Daten an, die Sie für einen Bericht erhalten können. Beispielsweise listet die Variable `searchTerm` Schlüsselwörter auf, die in E-Katalog-Suchen verwendet werden.
...
* **Bearbeiten**: Wählen Sie ein Viewer-Ereignis aus und klicken Sie auf die graue Schaltfläche **[!UICONTROL Anzeigen/]**). Wählen Sie in den Dropdown-Listen Adobe Dynamic Media Classic-Variable und Adobe Analytics-Variable eine andere Variable aus der jeweiligen Liste aus. Weitere Informationen finden Sie unter [Zuweisen von Adobe Analytics-Variablen zu Adobe Dynamic Media Classic-Viewer-Ereignissen und -Variablen](#assigning-adobe-analytics-variables-to-adobe-dynamic-media-classic-viewer-events-and-variables).
