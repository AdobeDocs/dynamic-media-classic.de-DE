...
Mit den Media Portal-Stileinstellungen können Sie die Oberfläche von Media Portal mit eigenen Unternehmenslogos und Farben anpassen. Verwenden Sie die Stileinstellungen, um Ihr Unternehmens-Branding auf Media Portal anzuwenden.
...
* **[!UICONTROL Anwendung]**: Konfigurieren Sie einen Farbverlauf, indem Sie Optionen in den Menüs der Hintergrundfarbverläufe auswählen.
...
Damit Medienportal-Benutzer die von Ihnen ausgewählten Stileinstellungen sehen können, müssen sie `?company=(company name)` an die URL anhängen, mit der sie auf das Medienportal zugreifen. Um beispielsweise Stileinstellungen anzuzeigen, können Medienportal-Benutzer, die auf das PortalCo-Unternehmen zugreifen, die folgende URL verwenden:
...
Erfahren Sie mehr über die Kommunikation von URL-Änderungen an Medienportal-Benutzer und das Einrichten einer Begrüßungs-E-Mail, damit neue Benutzer die richtige Medienportal-URL erhalten.

Siehe [Einrichten der Begrüßungs-E-Mail-Nachricht für Media Portal-Benutzer](adding-media-portal-users.md#setting_up_the_welcome_email_message_for_media_portal_users).
