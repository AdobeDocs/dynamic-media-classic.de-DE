---
title: Hochladen Primärer Bilder
...
* **Farbraum**: RGB ist der Farbraum für Web-Bildpräsentationen. Für den Druck häufig verwendete CMYK-Bilder werden beim Hochladen in RGB konvertiert. Es wird empfohlen, CMYK-Bilder mit eingebettetem ICC-Farbprofil (International Color Consortium) für die Konvertierung in RGB hochzuladen. Siehe auch [ICC (International Color Consortium)-Profile](/help/using/icc-profiles.md).
