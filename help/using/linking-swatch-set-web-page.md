---
title: Verknüpfen von Mustersets mit Web-Seiten
description: Erfahren Sie, wie Sie in Adobe Dynamic Media Classic ein Musterset mit einer Web-Seite verknüpfen.
...
# Verknüpfen von Mustersets mit Web-Seiten{#linking-a-swatch-set-to-a-web-page}

Nach dem Veröffentlichen eines Mustersets können Sie die zugehörige URL oder den Einbettungs-Code in Ihrer Website oder Anwendung verwenden. Anschließend können Sie die URL oder den Einbettungs-Code nach Bedarf bereitstellen, damit Benutzer das Farbfeldset auf Ihrer Website oder in Ihrem Programm anzeigen können.
