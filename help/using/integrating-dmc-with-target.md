...
Bevor Sie [!DNL Adobe Dynamic Media Classic] in [!DNL Target Standard/Premium] integrieren können, müssen Sie auf dem Bildschirm „Allgemeine Programmeinstellungen“ die Ziel-URL [!DNL Adobe Dynamic Media Classic]. Gehen Sie wie folgt vor, um Ihre Target-URL abzurufen und sie auf der Seite „Allgemeine Programmeinstellungen“ einzugeben

1. Melden Sie sich [!DNL Adobe Experience Cloud] bei Ihrem [!DNL Target Standard/Premium] Konto an.
1. Kopieren Sie die URL nach der Anmeldung in der Adressleiste Ihres Browsers nach bis einschließlich `.com`.

   Wenn die URL (URL-Pfade enthalten immer Schrägstriche, nicht umgekehrte Schrägstriche) in der Adressleiste `https://www.myfictionalsite.com/categories/admin/home.do` ist, kopieren Sie diesen Teil: `https://www.myfictionalsite.com`.
