...
>[!NOTE]
>
>Adobe Dynamic Media Classic empfiehlt, in Ihren Vorlagen transparente TIFF- oder PSD-Bilder in der exakten Größe zu verwenden, in der Sie sie auf Ihrer Website anzeigen möchten. Wenn Sie die Vorlage veröffentlichen, rufen Sie das Bild mit einer Bildvorgabe mit derselben Größe auf. Wenn Sie auf die Größe achten, wird sichergestellt, dass die Größe der Vorlage nicht auf eine Größe geändert (neu berechnet) wird, die größer oder kleiner als die Größe ist, mit der sie entworfen wurde.

Vorlagen können basierend auf Adobe Photoshop-PSD- oder Bilddateien erstellt werden.

Detaillierte Anweisungen zum Hochladen von Dateien finden Sie unter [Dateien hochladen](uploading-files.md#uploading_files). Beachten Sie beim Hochladen von Vorlagendateien Folgendes:
